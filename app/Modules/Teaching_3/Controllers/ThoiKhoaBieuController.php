...
class ThoiKhoaBieuController extends Controller
{
    ...
    public function index()
    {
        ...
        $thoikhoabieu = ThoiKhoaBieu::with(['phanCong','diaDiem'])->orderBy('id', 'DESC')->paginate($this->pagesize);
        $teacher  = teacher::all();
        $hocphan  = HocPhan::all();
        
        return view('Teaching_3::thoikhoabieu.index', compact('hocphan','teacher','thoikhoabieu','breadcrumb', 'active_menu'));
    }
    ...
    public function edit($id){
        ...
        $diadiem = DiaDiem::all();
        $thoikhoabieu = ThoiKhoaBieu::findOrFail($id);
        return view('Teaching_3::thoikhoabieu.edit', compact('thoikhoabieu','diadiem','hocphan','teacher','phancong','breadcrumb', 'active_menu'));
    }
