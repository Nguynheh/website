...
Route::prefix('admin')->name('admin.')->group(function () {
    // Route cho trang danh sách lớp học
    Route::get('/class', [ClassesController::class, 'index'])->name('class.index');

    // Route cho trang tạo lớp học mới
    Route::get('/class/create', [ClassesController::class, 'create'])->name('class.create');  // Thêm route 'admin.class.create'

    // Route để lưu lớp học mới (store)
